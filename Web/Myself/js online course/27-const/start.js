...
// Решение 1. Можно добавлять в содержимое массива, но сам тип нельзя изменить и переопределять его
// Решение 2. Тут мы пытаемся переопределить переменную в другой массив?
